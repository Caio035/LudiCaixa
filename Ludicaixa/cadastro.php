...
<body>
    ...
    <div>
        <form action="cadastro.php" method="POST">
            ...
            <br></br>
            <input class="inputUser" name="email" type="email" placeholder="Email" required></input>
            <br></br>
            <input class="inputUser" name="senha" type="password" placeholder="Senha" required></input>
            <br></br>
            <input name="politica"type="checkbox" required>
                <label for="politica">Eu li e concordo em aceitar os termos da <strong class="tem_conta__link">Política de Privacidade</strong></label></input>
            <br>
            <p><a href="oque_somos.php">Quem somos?</a></p>
            <br>
            <input class="button" type="submit" name="submit" id="submit">
            <p>Já possui uma conta? <strong><a class="tem_conta__link"href="login.php" target="blank">Clique aqui.</a></strong></p>
        </form>
    </div>
